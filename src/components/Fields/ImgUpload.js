...
import IconView from "../IconHover";
import "./field.scss";
...
export default function Previews({ handleFileSRC, value, multiple, showIcon, icon }) {
  ...
  return (
    <section className={!showIcon && "dropzoneImgContainer"}>
